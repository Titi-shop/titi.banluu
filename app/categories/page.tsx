...
export default function CategoriesPage() {
  ...
  <img
    ...
    alt="Banner"
    className="w-full h-[220px] sm:h-[260px] md:h-[400px] object-cover"
  />
</div>
      ...
      {/* =========================
          CONTENT
      ========================= */}
      <div className="mt-4 grid grid-cols-12 gap-2 px-
    ...
    {categories.map((c) => {
      ...
      return (
        ...
        >
          ...
          <span className="text-[10px] mt-1 line-clamp-2 text-center px-1">
            {t[key] || c.name}
          </span>
        </button>
      );
